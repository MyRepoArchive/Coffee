...
module.exports = {
  ...
  async execute(message, args, comando, client, prefix, connection) {
    ...
    connection.query(`update users set bankmoney = '${authorBankMoney+(depositMoney*0.8)}' where iduser = '${message.author.id}'`); 
    run(message, client, `<:${emojis.circlecheckverde}> Depósito realizado com sucesso! \`${100-100*0.8}% de taxa\``, emojis.circlecheckverde) // Mensagem de confirmação de pagamento
