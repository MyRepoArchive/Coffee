...
module.exports = {
  ...
  async execute(message, args, comando, client) { // Código executado quando o usuário usa o comando calculator 
    ...
    if (podeEnviarMsg) {
      const descEmbed = new Discord.MessageEmbed()
        .setColor(hex.blue2)
        .setTitle(`<:calculator:750013968432758875> Como usar o ${config.prefix}${comando}`)
