...
module.exports = async message => {
  ...
  return
  let concated = [].map((value, index, array) => {

  })
  for (let i = 0; i < possibleNamesCommand.length; i++) {
    concated = concated.concat(possibleNamesCommand[i].concat(possibleNamesCommand[i + 1]))
  }
