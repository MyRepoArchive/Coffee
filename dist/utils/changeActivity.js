    ...
    interval = setInterval(() => {
        ...
        switch (activityId // Para cada activityId é executado um setActivity() diferente e adicionado +1 no activityId
            ...
            case 1:
                ...
                break;
            case 2:
                bot.user?.setActivity(`Estou a ${((Date.now() - bot.instanciedTime.getTime()) /
                    60000).toFixed(0)}m ativo`, { type: 'STREAMING', url: 'https://github.com/joaoscoelho/Coffee' });
                activityId = 3;
                break;
            default:
                bot.user?.setActivity(`Estou em ${bot.guilds.cache.size} servidores`, {
...
exports.default = changeActivity;
